    ...
    <main className="page-shell">
      <section className="mx-auto flex max-w-4xl flex-col bg-white">
        ...
        <div className="flex flex-wrap gap-3 px-6 py-4">
          <Link className="btn-secondary rounded-[2px] px-5 py-2" href="/">
            返回首页
          </Link>
          <Link className="btn-secondary rounded-[2px] px-5 py-2" href="/orders">
            我的订单
          </Link>
          <Link className="btn-secondary rounded-[2px] px-5 py-2" href="/cart">
            购物车
          </Link>
          <Link className="btn-secondary rounded-[2px] px-5 py-2" href="/admin">
            访问后台示例页
          </Link>
          <LogoutButton className="btn-primary rounded-[2px] px-5 py-2" />
        </div>
      </section>
    </main>
  );
