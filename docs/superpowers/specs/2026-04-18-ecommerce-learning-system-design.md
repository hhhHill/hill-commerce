# Ecommerce Learning System Design

## 1. Overview

本项目是一个面向电商学习场景的单体模块化系统，目标是在保持单体应用开发效率的同时，具备清晰的模块边界和向高并发、异步化、服务化演进的能力。
...
### 6.1 Synchronous Transaction Flow
...
## 11. First Skeleton Scope

本次项目骨架生成范围如下：

### 11.1 Root Aggregation
